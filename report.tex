...
\texttt{d\{y\}} & 1, 2 & Datastore: 1=JSON (custom), 2=SQLite \\
	exttt{c\{z\}} & 1, 2, 3 & Compression: 1=None, 2=Elias (Gamma/Delta), 3=Zlib \\
...
\subsubsection{Elias (Gamma/Delta) Compression (z=2)}

\textbf{Implementation}:
\begin{itemize}
    \item Gap encoding: Store differences between sorted document IDs
    \item Elias (Gamma/Delta) encoding: Split into high and low bits
...
\end{itemize}
	...
	extbf{Why better than Elias (Gamma/Delta)?}:
\begin{itemize}
...
Elias (Gamma/Delta) & 164 & 3.97x & 45.72 & +1160\% \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
    \item \textbf{Elias (Gamma/Delta): +1160\% Latency Overhead}
    ...
    \begin{itemize}
        ...
        \item Elias (Gamma/Delta): Decode 10,000 numbers = 45ms (45,000x slower!)
    \end{itemize}
...
\midrule
Cold storage / Archive & Elias (Gamma/Delta) & Maximum compression, latency not critical \\
\midrule
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Lucene's custom compression: Optimized Elias (Gamma/Delta) + delta encoding
...
\begin{itemize}
    ...
    \item Elias (Gamma/Delta) achieves 3.97x compression at cost of 12.6x slower queries
...
Elias (Gamma/Delta) & 74.8\% smaller & +1160\% slower \\
\bottomrule
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{Archival/cold storage}: Elias (Gamma/Delta) (space-critical)
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Two compression methods}: Elias (Gamma/Delta) (custom), Zlib (library)
